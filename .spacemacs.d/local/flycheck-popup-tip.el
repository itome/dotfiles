;;; this package is forcked from https://github.com/flycheck/flycheck-popup-tip
...
(defcustom flycheck-popup-tip-margin 0
   "Side margin of tooltip"
   :group 'flycheck-popup-tip
   :type 'integer)
  ...
  (when errors
    (setq flycheck-popup-tip-object
          (popup-tip
           ...
           :margin-left flycheck-popup-tip-margin
           :margin-right flycheck-popup-tip-margin
           :nostrip t
           :nowait t))
